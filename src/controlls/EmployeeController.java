...
public class EmployeeController {
    ...
    public static JTextField txtdiachi_NV;
    ...
    public static void initialize(JFrame frame, JTable table, JTextField txtManv,
            ...
            JTextField txtnamsinh, JTextField txtsodienthoai_NV, JTextField txtemail, JTextField txtdiachi_NV, JLabel lblhinh, JButton btncapnhat, JButton btnThem,
    ...
    public static void edit() {
        String MaNV = (String) table.getValueAt(curr, 0);
    ...
    public static void setForm(NhanVien kh) {
        ...
        if(NhanVien.list.get(0).equals(kh)){
            rdoAdmin.setSelected(true);
        }
        else if(NhanVien.list.get(1).equals(kh)){
            rdoKho.setSelected(true);
        }
        else if(NhanVien.list.get(2).equals(kh)){
